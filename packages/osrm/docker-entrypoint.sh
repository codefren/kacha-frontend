...
osrm-routed $OSRM_DATA_PATH/$OSRM_DATA_LABEL.osrm --max-viaroute-size 10000 --max-trip-size 10000 --max-table-size 10000 --max-matching-size 10000 --max-nearest-size 10000 &
child=$!
wait "$child"
