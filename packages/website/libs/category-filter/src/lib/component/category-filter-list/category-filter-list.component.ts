...
@Component({
  selector: 'easyroute-category-filter-list',
  templateUrl: './category-filter-list.component.html',
  styleUrls: ['./category-filter-list.component.scss']
})
    ...
    this.filterTable = $(SubFiltertable).DataTable({
        ...
        columns: [
                        ...
                        if (data) {
                            return (
                                '<div class="text-center">' +
                                    '<button class="btn btn-default activeFilter warning text-center green' +
                                        '" >' +
                            ...
                            /* return (`
                              <div class="row reset justify-content-center">
                                <div class="round-new ">
                                  <input type="checkbox" class="activeFilter" id="filter_${ row.id }" checked="true" ${disabled} />
                                  <label for="filter_${ row.id }"></label>
                                </div>
                              </div>
                            `);
                            */
                            ...
                            return (
                                '<div class="text-center">' +
                                    '<button class="btn btn-default activeFilter warning text-center gray' +
                                        '">' +
                                        this._translate.instant('GENERAL.ACTIVATE') +
                                    '</button> ' +
                                '</div>'
                            ...
                            /* return (`
                              <div class="row reset justify-content-center">
                                <div class="round-new ">
                                  <input type="checkbox" class="activeFilter" id="filter_${ row.id }" ${disabled} />
                                  <label for="filter_${ row.id }"></label>
                                </div>
                              </div>
                          `); */
            ...
            },
            {
                ...
                render: () => {
                    return `<span class="filterEditar point"> <img class="icons-datatable point" src="assets/icons/optimmanage/create-outline.svg"></i></span>`;
                },
            },
        ],
        order: [1, 'asc'],
...
filterEditar(tbody: any, table: any, that = this) {
    ...
    $(tbody).on('click', 'span.filterEditar', function() {
        ...
        that._router.navigate(['category-filter', data.id]);
    });
}
