...
@Component({
  selector: 'easyroute-orders-modal-search-client',
  templateUrl: './orders-modal-search-client.component.html',
  styleUrls: ['./orders-modal-search-client.component.scss']
})
export class OrdersModalSearchClientComponent implements OnInit {
  table: any;
