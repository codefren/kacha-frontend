...
import { Orders, OrdersProductsInterface, Point, ProductsInterface } from '@optimroute/backend';
import { ConfirmModalComponent, dateToObject, OrdersMessages, ToastService } from '@optimroute/shared';
...
import { OrdersModalConfirmationComponent } from '../../component/orders-form/orders-modal-confirmation/orders-modal-confirmation.component';
import { OrdersModalSearchClientComponent } from '../../component/orders-form/orders-modal-search-client/orders-modal-search-client.component';
import { OrdersModalSearchProductsComponent } from '../../component/orders-form/orders-modal-search-products/orders-modal-search-products.component';

@Component({
  selector: 'easyroute-historical-preparation-form',
  templateUrl: './historical-preparation-form.component.html',
  styleUrls: ['./historical-preparation-form.component.scss']
})
export class HistoricalPreparationFormComponent implements OnInit {
  ...
  ngOnInit() {
    this.preferencesFacade.ordersPreferences$.pipe((take(1))).subscribe((data) => {
  ...
  changeStatus(id: any) {
      ...
      console.log(id, 'id de cambiar status');
                      ...
                      let products = {
                          ...
                          company_product_price: {
                              ...
                              company_product: {
                                  price: dataElement.price,
                                  category: {
                                      companyId: dataElement.company_product.category.companyId,
                                      id: dataElement.company_product.category.id,
                                      name: dataElement.company_product.category.name,
                                  },
                                  id: dataElement.id,
