...
@Component({
  selector: 'easyroute-historical-orders-from',
  templateUrl: './historical-orders-from.component.html',
  styleUrls: ['./historical-orders-from.component.scss']
})
export class HistoricalOrdersFromComponent implements OnInit {
  orderForm: FormGroup;
  orders: Orders;
  ordersMessages: any;
  closeResult: string;
