...
@Component({
  selector: 'easyroute-bill-notices',
  templateUrl: './bill-notices.component.html',
  styleUrls: ['./bill-notices.component.scss']
})
export class BillNoticesComponent implements OnInit {
