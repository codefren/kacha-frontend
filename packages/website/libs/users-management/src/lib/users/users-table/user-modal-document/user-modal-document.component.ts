...
import { CustomDatepickerI18n, dateToObject, getToday, Language, MomentDateFormatter } from '@optimroute/shared';
import { NgbDateParserFormatter, NgbDatepickerI18n, NgbDateStruct, NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { FormGroup, FormBuilder, Validators } from '@angular/forms';

@Component({
  selector: 'easyroute-user-modal-document',
  templateUrl: './user-modal-document.component.html',
  styleUrls: ['./user-modal-document.component.scss'],
  providers: [
    Language,
...
export class UserModalDocumentComponent implements OnInit {
  ...
  validaciones() {
    ...
    this.form = this.fb.group(
      {
        id: [this.document.id],
        userId: [this.document.userId, [Validators.required]],
  ...
  submit (){
    ...
    documentData.append('userId', this.document.userId);
