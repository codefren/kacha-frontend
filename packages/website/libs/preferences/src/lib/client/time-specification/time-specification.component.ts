...
import { ModalTimeSpecificationComponent } from './modal-time-specification/modal-time-specification.component';
...
import { ToastService, secondsToDayTimeAsString } from '@optimroute/shared';
...
@Component({
  selector: 'easyroute-time-specification',
  templateUrl: './time-specification.component.html',
  styleUrls: ['./time-specification.component.scss']
})
export class TimeSpecificationComponent implements OnInit {
  ...
  change: string = 'servies-type';
    ...
    modalAddServiceType(){
        ...
        const modal = this._modalService.open(ModalTimeSpecificationComponent, {
