...
import { CategoryMessages, LoadingService, ToastService, dayTimeAsStringToSeconds, secondsToDayTimeAsString } from '@optimroute/shared';
...
@Component({
  selector: 'easyroute-modal-time-specification',
  templateUrl: './modal-time-specification.component.html',
  styleUrls: ['./modal-time-specification.component.scss']
})
export class ModalTimeSpecificationComponent implements OnInit {
