...
import { ModalAddGeneralCategoryComponent } from '../categories/modal-add-general-category/modal-add-general-category.component';
...
import { ModalAddGeneralSubCategoryComponent } from './modal-add-general-sub-category/modal-add-general-sub-category.component';
...
declare var $: any;
@Component({
  selector: 'easyroute-sub-categories',
...
export class SubCategoriesComponent implements OnInit, OnDestroy {
  ...
  cargar() {
    ...
    if (this.SubCategoriesTable) {
        this.SubCategoriesTable.clear();
        this.SubCategoriesTable.state.clear();
    }
    ...
    this.SubCategoriesTable = $(Subtable).DataTable({
       ...
       columns: [
                ...
                if (disabled) {
                    ...
                    if (data) {
                        ...
                        return (
                             ...
                             '<buttom title="Activar" class="btn btn-primary activeSubCategory btn-entregado btn-status-datatable">Activado</buttom>'
                        );
                        ...
                        return (
                            ...
                            '<buttom title="desactivar"class="btn btn-primary activeSubCategory btn-pendiente btn-status-datatable">Inactivo</buttom>'
                        );
        ...
        },
        {
            ...
            title: '',
            render: (data, type, row) => {
                return `<span class="subCategoryEditar point"> <img class="icons-datatable point" src="assets/icons/editSettings.svg"></span>`;
            },
        },
    ],
...
subCategoryEditar(tbody: any, table: any, that = this) {
  ...
  $(tbody).on('click', 'span.subCategoryEditar', function() {
      ...
      that.openModalEditSubCategory(data);
  });
}
...
openModalCreateSubCategory(){
    ...
    const modal = this._modalService.open( ModalAddGeneralSubCategoryComponent, {
        backdrop: 'static',
        backdropClass: 'customBackdrop',
        size :'md',
        centered: true,
    ...
    modal.componentInstance.title = this._translate.instant('GENERAL.SUBCATEGORIES');
...
openModalEditSubCategory(data: any){
