...
@Component({
  selector: 'easyroute-vehicle-material-accessories',
  templateUrl: './vehicle-material-accessories.component.html',
  styleUrls: ['./vehicle-material-accessories.component.scss']
})
export class VehicleMaterialAccessoriesComponent implements OnInit {
