...
import { ModalAttachTicketComponent } from '@optimroute/shared';
declare var $;
@Component({
  selector: 'easyroute-management-vehicles-analysis-repairs',
  templateUrl: './management-vehicles-analysis-repairs.component.html',
  styleUrls: ['./management-vehicles-analysis-repairs.component.scss']
})
export class ManagementVehiclesAnalysisRepairsComponent implements OnInit {

  @Input() idVehicle: any;
  filter: FilterState = {
    name: 'vehicle_analysis_repair',
    values: {
...
cargar() {
    ...
    let url = environment.apiUrl + 'vehicle_analysis_detail_repair/' + this.idVehicle;
