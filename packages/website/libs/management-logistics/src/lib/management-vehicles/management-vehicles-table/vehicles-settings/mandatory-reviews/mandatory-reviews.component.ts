...
@Component({
  selector: 'easyroute-mandatory-reviews',
  templateUrl: './mandatory-reviews.component.html',
  styleUrls: ['./mandatory-reviews.component.scss']
})
export class MandatoryReviewsComponent implements OnInit {
