...
import { ModalDeleteServiceComponent } from './modal-delete-service/modal-delete-service.component';
@Component({
  selector: 'easyroute-service-specification',
...
modalAddService(){
  ...
  // modal.componentInstance.data = this.providersType;
