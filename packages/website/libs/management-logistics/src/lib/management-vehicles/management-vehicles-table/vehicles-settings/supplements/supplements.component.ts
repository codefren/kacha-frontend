...
import { ModalAddSuppkementsComponent } from './modal-add-suppkements/modal-add-suppkements.component';

@Component({
  selector: 'easyroute-supplements',
...
updateIsActive(Id: number, element: any , vehicle: any) {
  ...
  modalAddOtherLicense(){
    ...
    const modal = this._modalService.open(ModalAddSuppkementsComponent, {
