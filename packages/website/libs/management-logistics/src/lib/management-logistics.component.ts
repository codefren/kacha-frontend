...
@Component({
    ...
    templateUrl: './management-logistics.component.html',
    styleUrls: ['./management-logistics.component.scss'],
})
export class ManagementLogisticsComponent implements OnInit {
