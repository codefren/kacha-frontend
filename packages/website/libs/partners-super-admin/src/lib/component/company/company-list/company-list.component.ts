...
import { dateToObject, getDateMomentHours, objectToString } from '../../../../../../shared/src/lib/util-functions/date-format';
...
@Component({
  selector: 'easyroute-company-list',
...
cargar() {
    ...
    let url = this.me
        ? environment.apiUrl +
        'company_partner_datatables?me=true'
        ...
        : environment.apiUrl + 'company_partner_datatables?'
...
`);
    ...
    this.initEvents('#partnersCompany tbody', this.table);
}
...
editar(tbody: any, table: any, that = this) {
    ...
    $(tbody).on('click', 'span.editar', function () {
        ...
        that._router.navigate([`/partners-super-admin/${data.id}`]);
