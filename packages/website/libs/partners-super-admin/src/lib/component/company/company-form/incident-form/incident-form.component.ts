...
import { Incident } from '@optimroute/backend';
@Component({
...
updateErpIncident(obj: [number, Partial<Company>]){
    ...
    if (this.isFormInvalid()) {
        ...
        this.loadingService.showLoading();
            ...
            this.companiesService.updateCompanyPartner(obj[0], obj[1]).pipe(take(1)).subscribe(
                (data: any) => {
                    ...
                    this.companiesService.getCompanyPartner(this.company.id).pipe(take(1)).subscribe(
                        (resp: any) => {
                            ...
                            this.router.navigate(['/partners-super-admin']);
       ...
       /*  this.companiesFacade.updated$
            ...
            .subscribe((data) => {
                if (data) {
                    ...
                    this.companiesService.getCompanyPartner(this.company.id).subscribe(
                        (resp: any) => {
