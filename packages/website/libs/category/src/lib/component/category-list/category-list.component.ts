...
@Component({
    selector: 'easyroute-category-list',
...
export class CategoryListComponent implements OnInit {
    ...
    cargar() {
        ...
        this.table = $(table).DataTable({
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: (data, type, row) => {
                        return `<span class="editar point"> <img class="icons-datatable point" src="assets/icons/optimmanage/create-outline.svg"></span>`;
                    },
                },
            ],
            order: [1, 'asc'],
        ...
        this.editar('#category tbody', this.table);
        this.isActive('#category tbody', this.table);
    }
