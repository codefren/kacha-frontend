...
import { NgbDate, NgbDateParserFormatter, NgbDateStruct, NgbDatepickerI18n, NgbModal } from '@ng-bootstrap/ng-bootstrap';
import { TranslateService } from '@ngx-translate/core';
import { BackendService } from '@optimroute/backend';
import { CustomDatepickerI18n, Language, LoadingService, MomentDateFormatter, ToastService } from '@optimroute/shared';
...
export class AutomationComponent implements OnInit {
  ...
  changeDate(name: string, dataEvent: NgbDate) {
    ...
    if (name == 'from') {
      ...
      console.log( objectToString(dataEvent), 'evento para enviar');
